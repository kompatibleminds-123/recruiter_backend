...
function PortalApp({ token, onLogout }) {
  ...
  function loadCandidateIntoInterview(candidateId) {
    ...
    setInterviewForm({
      ...
      currentCompany: candidateDraft.currentCompany || matched?.currentCompany || "",
      currentDesignation: candidateDraft.currentDesignation || matched?.currentDesignation || "",
      totalExperience: candidateDraft.totalExperience || matched?.totalExperience || "",
      relevantExperience: candidateDraft.relevantExperience || matched?.relevantExperience || "",
      highestEducation: candidateDraft.highestEducation || matched?.highestEducation || "",
      currentOrgTenure: candidateDraft.currentOrgTenure || matched?.currentOrgTenure || "",
  ...
  function openSavedAssessment(assessment) {
    ...
    setInterviewForm({
      ...
      currentCompany: assessment?.currentCompany || candidateDraft.currentCompany || "",
      currentDesignation: assessment?.currentDesignation || candidateDraft.currentDesignation || "",
      totalExperience: assessment?.totalExperience || candidateDraft.totalExperience || "",
      relevantExperience: assessment?.relevantExperience || candidateDraft.relevantExperience || "",
      highestEducation: assessment?.highestEducation || candidateDraft.highestEducation || "",
      currentOrgTenure: assessment?.currentOrgTenure || candidateDraft.currentOrgTenure || "",
